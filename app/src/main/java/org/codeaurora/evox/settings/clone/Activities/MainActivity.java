...
import org.codeaurora.evox.settings.clone.Activities.ApplicationsActivity;
import org.codeaurora.evox.settings.clone.Activities.BatteryActivity;
import org.codeaurora.evox.settings.clone.Activities.EvolverActivity;
import org.codeaurora.evox.settings.clone.Activities.MainActivity;
import org.codeaurora.evox.settings.clone.Activities.SystemActivity;
import org.codeaurora.evox.settings.clone.Activities.WallpaperActivity;
import org.codeaurora.evox.settings.clone.databinding.ActivityMainBinding;
import org.codeaurora.evox.settings.clone.R;
import org.codeaurora.evox.settings.clone.models.ModelMain;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setValue(
                ...
                util.title[18],
                util.subtitle[18] =
                        Build.MANUFACTURER.toLowerCase() + " " + Build.MODEL.toLowerCase(),
                util.imgid[18]);
        setValue(
                binding.text21,
                binding.subtext21,
